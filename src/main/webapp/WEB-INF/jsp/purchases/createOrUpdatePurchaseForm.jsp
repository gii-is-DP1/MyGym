	...
	<jsp:attribute name="customScript">
        <script type="text/javascript">
        	$(function() {
            	...
            	var rowTemplate = '<div class="card col mx-4 mt-4"><input type="hidden" name="productPurchases" value="#PRODUCT#;#AMOUNT#;#PRICE#" /><div class="card-title">#NAME#</div><div class="card-body"><p>Amount: #AMOUNT#</p><p>Price: #PRICE#</p><button class="delete-btn">Delete</button></div></div>';
